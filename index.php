...
<body class="bg-gradient-to-br from-[#1e1b2e] to-[#3a1b47] text-white min-h-screen flex items-center justify-center">

    <!-- logo -->
    <img src="img/logo.svg"
        class="w-12 h-12 max-md:w-8 max-md:h-8 bg-[#e75d4e] absolute m-4 left-0 top-0 flex items-center justify-center rounded" alt="">
    ...
    <div class="container mx-auto px-4 md:px-8 lg:px-16">
        <div class="flex flex-col xl:flex-row items-center justify-between space-y-8 xl:space-y-0">
            <!-- Sidebar -->
            <div
                class="flex flex-col items-center space-y-6 xl:space-y-8 max-xl:w-full max-xl:absolute max-xl:top-0 max-xl:p-2">

                <!-- Icons -->
                <div class="flex flex-row xl:flex-col space-x-10 xl:space-x-0  xl:space-y-10">
                    <a href="#" class="text-white text-2xl hover:text-[#e75d4e]"><svg class="w-6 fill-[currentColor]"
                    ...
                    <a href="#" class="text-white text-2xl hover:text-[#e75d4e]">
                        <svg class="w-6 fill-[currentColor]" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="#" class="text-white text-2xl hover:text-[#e75d4e]">
                        <svg class="w-6 fill-[currentColor]" viewBox="0 0 496 512" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="#" class="text-white text-2xl hover:text-[#e75d4e]">
                        <svg class="w-6 fill-[currentColor]" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex flex-col-reverse items-center md:flex-row justify-between space-y-8 md:space-y-0">
                ...
                <div class="flex-1 text-center md:text-left">
                    ...
                    <div class="mt-8 flex flex-wrap justify-center md:justify-start gap-4">
                        <a href="#"
                            class="box-shadow-custom w-auto flex items-center gap-2 text-[#191627] px-4 py-2 rounded-full font-bold shadow-lg bg-white hover:bg-gray-200 transition-all sm:text-sm md:text-base">
                            TAKE A LOOK

                            <svg class="w-5 h-8" viewBox="0 0 51 155" fill="none" xmlns="http://www.w3.org/2000/svg">
